...
init() {
    N_CPUS=$(nproc --all)
		...
		docker run -d --name poggers-chinook --network=host -e DATABASE_URL='postgres://postgres:postgres@127.0.0.1:5432/chinook' -e SERVER_ADDR=0.0.0.0:7080 -e POOL_SIZE=100 poggers 
}
