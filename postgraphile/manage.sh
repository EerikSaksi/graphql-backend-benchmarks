...
init() {
    ...
    docker run --name postgraphile-chinook --network=host -d hasura/postgraphile:latest postgraphile -c 'postgres://admin@172.17.0.1:7432/chinook' --host 0.0.0.0 --max-pool-size 100 --cluster-workers "$n_cpus"
}
